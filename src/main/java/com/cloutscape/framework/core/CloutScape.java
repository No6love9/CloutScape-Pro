...
import com.cloutscape.framework.managers.GameManager;
import com.cloutscape.framework.managers.ProfitTracker;
import com.cloutscape.framework.managers.TradeManager;
...
@ScriptManifest(
    ...
    author = "ikingsnipe",
    version = "2.0.0",
    description = "The definitive 2026 OSRS Casino Framework. RuneLite Edition with Jagex Account support.",
    category = Category.CASINO
)
public class CloutScape extends AbstractScript implements ChatListener, PaintListener {
    ...
    private JagexAccountHandler jagexHandler;

    @Override
    public void onStart() {
        log("Initializing Clout♧Scape Framework v2.0.0...");
        ...
        jagexHandler = new JagexAccountHandler(config.jagexEmail, config.jagexPassword, config.jagexEnabled);
        jagexHandler.handleLogin();
    ...
    private void drawOverlay(Graphics2D g) {
        ...
        g.drawString("Clout♧Scape Pro v2.0.0", 25, 55);
